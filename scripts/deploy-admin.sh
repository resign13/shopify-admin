...
cd "$root/$backend"
.venv/bin/python -m py_compile app.py db.py workbench.py image_delivery.py order_management.py module_permissions.py order_matrix_export.py contracts.py
