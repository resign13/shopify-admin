...
def seed():
    with db.get_connection() as conn:
        conn.execute('TRUNCATE admin_audit_logs,inventory_receipts,inventory_import_receipts,admin_users,store_users,products,product_categories,orders,homepage_configs,banners RESTART IDENTITY CASCADE')
    tokens={}
